 ...
 * DataRetreival and converts the data into 2D string arrays to be sent to
 * DisplayData
 * 
 * @author David Lin
 *
 */
public class CO2_Energy_Pollution extends Calculation {
	...
	public void calculate(DataRetrieval data) {
		...
		DisplayData.setData("CO2 Emission vs. Energy Use vs. Air Pollution", yearsArray, dataArray);
	}
