 ...
 *
 */
public class HealthExpvsMortality extends Calculation {
	...
	public void calculate(DataRetrieval data) {
		...
		DisplayData.setData("Current Health expenditure per capita vs. Infant Mortality Rate",yearsArray,dataArray);
	}
